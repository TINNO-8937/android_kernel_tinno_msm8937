...
static int __init sensors_state_init(void)
{
	...
	printk("Market_Area = %s\n", Market_Area);
	printk("Proximity_sensor = %d\n", Proximity_sensor);
	printk("Light_sensor = %d\n", Light_sensor);
	printk("Gyroscope_sensor = %d\n", Gyroscope_sensor);
	printk("Acceleration_sensor = %d\n", Acceleration_sensor);
	printk("Magnetic_sensor = %d\n", Magnetic_sensor);
	printk("OTG_open = %d\n", OTG_open);
	printk("Hall = %d\n", Hall);
