 ...
 */
#define FTS_UPGRADE_FW_APP                      "include/firmware/FT5346DQQ_7601_ID0X80_V13_D01_20170516_app.i"

/*
 * if FTS_GET_VENDOR_ID_NUM >= 2, fw corrsponding with FTS_VENDOR_2_ID
 * define your own fw_app, the sample one is invalid
 */
#define FTS_UPGRADE_FW2_APP                     "include/firmware/FT5346DQQ_7601_ID0X80_V13_D01_20170516_app.i"

/*
 * if FTS_GET_VENDOR_ID_NUM == 3, fw corrsponding with FTS_VENDOR_3_ID
 * define your own fw_app, the sample one is invalid
 */
#define FTS_UPGRADE_FW3_APP                     "include/firmware/FT5346DQQ_7601_ID0X80_V13_D01_20170516_app.i"
